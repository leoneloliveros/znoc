...
//        print_r($this->db->last_query().';<br>');
   ...
   OR AC.OWNER LIKE '%ECM4900E%'
    ...
    /*public function getescalahm($fdesde, $fhasta, $condicion){

        $query=$this->db->query("

            SELECT

            DATE_FORMAT(CREATIONDATE, '%Y-%m-%d-%T') AS the_date, COUNT(*) AS count,
            ...
            and DATE_FORMAT(CREATIONDATE, '%Y-%m-%d-%T') BETWEEN '$fdesde' AND '$fhasta'
