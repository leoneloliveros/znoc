...
//        print_r($this->db->last_query().';<br>');
    ...
    public function getTareasFOPerformance($fdesde, $fhasta) {
            ...
            IC.ACTUALFINISH AS FECHA_CIERRE_INCIDENTE,WO.MODIFYBY AS CREADOR,WO.CREATEDATE AS FECHA_NOTA,WO.DESCRIPTION AS RESUMEN_NOTA,WO.DESCRIPTION_LONGDESCRIPTION AS DETALLE_NOTA, AL.NODE, AL.NOMB_ALARMA, AL.CREADA, AL.CANCELADA
